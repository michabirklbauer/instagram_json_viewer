...
backup version that still has the `messages.json` file it is probably safer to use the older release found here [https://github.com/t0xic-m/instagram_json_viewer/tree/v2020.12.07](https://github.com/t0xic-m/instagram_json_viewer/tree/v2020.12.07) or you can directly download it [here](https://github.com/t0xic-m/instagram_json_viewer/archive/v2020.12.07.zip).
...
![MSGSTATS](docs/message_stats.jpg)
